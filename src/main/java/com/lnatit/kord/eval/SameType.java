...
//            new AsymmetricEnumMatrix<>(SameType.class, false);
    public static final AsymmetricEnumMatrix<SameType, Scene> MATRIX =
            new AsymmetricEnumMatrix<>(SameType.class, new Scene(false, false));

    static {
        // TODO init matrix, combine two matrices
        Scene both = new Scene(true, true);
        Scene release = new Scene(false, true);
        MATRIX.put(MAIN, MODIFIER, both);
        MATRIX.putAll(DISJOINT, release, MAIN, MODIFIER);
    }
}
